...
public class SaveLoad {
    ...
    public void save(String filename) throws IOException{
        ...
        writer.write("\n");
        writer.write(String.valueOf(this.playerstate.x)+" "+String.valueOf(this.playerstate.y)+" "+String.valueOf(this.playerstate.aex)+" "+String.valueOf(this.playerstate.aey));
        writer.close();
    }

    public void load(String filename, Player player) throws NumberFormatException, IOException{
        ...
        while ((strLine = br.readLine()) != null){
            ...
            if (k <= totaleng){
                ...
                SkillItem si = new SkillItem(b);
                player.addToInventory(si);
            }
            else{
                player.setPosition(Integer.valueOf(tokens[0]),Integer.valueOf(tokens[1]),Integer.valueOf(tokens[2]), Integer.valueOf(tokens[3]));
            }
    }
}
}